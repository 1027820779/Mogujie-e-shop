			...
			<div class="box_frame">
               ...
               <?php }?>
					...
					<ul>
						...
						<li class="selected"><a href="<?php echo U('myAddress')?>">我的地址</a></li>
					</ul>
					<div class="qcode">
				...
				<div class="right_box">
					...
					<div class="basic_info_frame">
							...
							<?php foreach ($address_data as $v){?>
							<tr class="adat">
								<td><?php echo $v['pca']?></td>
								<td><?php echo $v['postcode']?></td>
								<td><?php echo $v['street_add']?></td>
								<td><?php echo $v['receipt_name']?></td>
								<td><?php echo $v['phone_number']?></td>
								<td>
									<a href="">修改</a>
									<a href="javascript:if(confirm('确认删除吗?')) location.href='<?php echo U('Ucenter/delCollect',array('adid'=>$v['adid']))?>';">删除</a>
								</td>
							</tr>
							<?php }?>
						</table>
