				...
				<div class="header_top">
					...
					<ul class="top_menu">
						...
						<li class="s1 icon-b login_user">
							...
							<ul>
								<li><a href="http://localhost/houdun/mogujie/index.php?m=Home&c=Ucenter&a=index">个人中心</a></li>
               ...
               <?php }?>
				...
				<div class="right_box">
					<div class="menu_titles">
						<a href="<?php echo U('myOrder')?>">我的收藏(<?php echo $collect_count?>)</a>
						<a class="ss_alink" href="<?php echo U('myOrder0')?>">待付款<span>(<?php echo $morder0?>)</span></a>
					...
					<div class="order_info_frame">
						<table class="tables">
							...
							<?php foreach ($morderlist_data as $v){?>
							<tr class="adat">
								<td>
								...
								<td><?php echo $v['seld_num']?></td>
								<td><?php echo $v['total_price']?></td>
								<td>
									<a style="margin:0 5px 0px 5px;" href="javascript:if(confirm('确认删除吗?')) location.href='<?php echo U('Ucenter/delmlnt',array('olid'=>$v['olid']))?>';">删除</a>
						...
						<table style="border-collapse: collapse;width: 100%;font-family: sans-serif;">
							<tr style="height: 45px;background: #f7f7f7;color: #999999;font-size: 12px;">
								<th>订单号:&nbsp;<?php echo $m_data0['order_num']?></th>
								<th>下单时间:&nbsp;<?php echo date('Y-m-d',$m_data0['create_time'])?></th>
								<th>总价格:&nbsp;<?php echo $m_data0['all_price']?>元</th>
							</tr>
						</table>
					</div>
				</div>
