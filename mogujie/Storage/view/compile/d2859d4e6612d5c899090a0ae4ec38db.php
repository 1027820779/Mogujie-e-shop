							...
							<tr class="adat">
								...
								<td>
									<a style="margin:0 5px 0px 5px;color:white;background: #f46;padding: 2px 6px 2px 6px;font-size: 12px;border-radius: 2px;"
     									href="<?php echo U('Cart/paymoney',array('ddh'=>$v['order_num']))?>">付款</a>
									<a style="margin:0 5px 0px 5px;" href="<?php echo U('Ucenter/showmor',array('oid'=>$v['oid']))?>">查看商品</a>
									<a style="margin:0 5px 0px 5px;" href="javascript:if(confirm('确认删除吗?')) location.href='<?php echo U('Ucenter/delnotpay',array('oid'=>$v['oid']))?>';">删除</a>
