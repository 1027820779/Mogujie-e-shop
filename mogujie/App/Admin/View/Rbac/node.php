...
<html>
	...
	<body>
		<div style="text-align:center;"  class="alert alert-success"><span>权限管理 > 节点列表</span><a style="float:right;" href="{{U('Type/attr_type_add',array('tid'=>3))}}" class="btn btn-sm btn-info">添加节点</a></div>
