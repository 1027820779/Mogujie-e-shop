...
<html>
	...
	<body>
		<div style="text-align:center;"  class="alert alert-success"><span>权限管理 > 用户列表</span><a style="float:right;" href="{{U('Type/attr_type_add',array('tid'=>1))}}" class="btn btn-sm btn-info">添加用户</a></div>
