...
<html>
	...
	<body>
		...
		<div class="alert alert-success" style="text-align:center;"><a style="float:left;" href="{{U('index')}}" class="btn btn-sm btn-primary">&lt;-返回</a>{{$parent['cname']}} > 添加分类</div>
		...
		<div class="form-group">
			...
			<select name="type_tid" class="form-control">
				<option value="{{$parent['tid']}}">{{$parent['tname']}}</option>
			</select>
		</div>
		<div class="form-group">
